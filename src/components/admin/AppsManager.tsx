    ...
    <div className="space-y-6 pb-20 animate-fadeIn text-slate-800">
      ...
      {isEditing && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <form
            onSubmit={handleSave}
            className="w-full max-w-2xl rounded-2xl border border-slate-200 bg-white p-6 md:p-8 space-y-5 shadow-2xl relative max-h-[85vh] overflow-y-auto text-left animate-fadeIn"
          >
            <button
              type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  onClick={addTag}
                  className="px-4 rounded-lg bg-[#2C3EFE] text-xs font-bold text-white hover:bg-[#2230d6] cursor-pointer border-0"
                >
                  Add Tag
                </button>
              </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex flex-col gap-2 p-3 rounded-xl border border-slate-200 bg-slate-50">
                ...
                <button
                  type="button"
                  onClick={addFaq}
                  className="self-end px-4 py-1.5 rounded-lg text-white hover:bg-[#2230d6] text-xs font-bold bg-[#2C3EFE] cursor-pointer border-0"
                >
                  Add FAQ
                </button>
              </div>
            ...
            <div className="flex items-center gap-3 justify-end pt-3 border-t border-slate-200">
              ...
              <button
                type="submit"
                className="px-5 py-2 rounded-xl bg-[#2C3EFE] text-white font-extrabold text-xs shadow-sm hover:bg-[#2230d6] transition-all cursor-pointer border-0"
              >
