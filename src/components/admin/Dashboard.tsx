...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  const [settingsTab, setSettingsTab] = useState<'header' | 'banners' | 'footer' | 'theme' | 'stats'>('header');
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          {viewMode === 'metrics' && onNavigateToManager && (
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-[#2C3EFE] hover:bg-[#2230d6] text-white font-extrabold text-xs shadow-sm transition-all active:scale-98 cursor-pointer border-0"
            >
        ...
        <>
          ...
          <form onSubmit={handleSaveSettings} className="space-y-6 text-left">
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      placeholder="e.g., https://site.com/logo.png (leave blank for default Zap logo)"
              ...
              <section className="p-4 rounded-xl border border-slate-200 bg-white shadow-sm space-y-4">
                ...
                <div className="space-y-3.5">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <label className="text-[10px] text-slate-400 font-extrabold uppercase block">User Rating</label>
                      <input type="number" step="0.1" min="0" max="5" value={userRating} onChange={(e) => setUserRating(parseFloat(e.target.value))} className="w-full h-9 px-3 rounded-lg text-xs bg-white border border-slate-300 text-slate-850 outline-none focus:border-blue-500 font-bold" />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[10px] text-slate-400 font-extrabold uppercase block">Rating Count</label>
                      <input type="number" value={ratingCount} onChange={(e) => setRatingCount(parseInt(e.target.value))} className="w-full h-9 px-3 rounded-lg text-xs bg-white border border-slate-300 text-slate-850 outline-none focus:border-blue-500 font-bold" />
                    </div>
                  </div>
                  <div className="space-y-1">
                    <label className="text-[10px] text-slate-400 font-extrabold uppercase block">Telegram Subscribers</label>
                    <input type="text" value={telegramSubscribers} onChange={(e) => setTelegramSubscribers(e.target.value)} placeholder="e.g., 32K+" className="w-full h-9 px-3 rounded-lg text-xs bg-white border border-slate-300 text-slate-850 outline-none focus:border-blue-500 font-bold" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[10px] text-slate-400 font-extrabold uppercase block">Verified Apps Count</label>
                    <input type="text" value={verifiedApps} onChange={(e) => setVerifiedApps(e.target.value)} placeholder="e.g., 89+" className="w-full h-9 px-3 rounded-lg text-xs bg-white border border-slate-300 text-slate-850 outline-none focus:border-blue-500 font-bold" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[10px] text-slate-400 font-extrabold uppercase block">Daily Payouts</label>
                    <input type="text" value={dailyPayouts} onChange={(e) => setDailyPayouts(e.target.value)} placeholder="e.g., ₹50K+" className="w-full h-9 px-3 rounded-lg text-xs bg-white border border-slate-300 text-slate-850 outline-none focus:border-blue-500 font-bold" />
                  </div>
                </div>
              </section>
            )}
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="dark-luxury-coin">Dark Luxury Coin (Midnight & Gold)</option>
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full px-5 py-3 rounded-xl bg-[#2C3EFE] hover:bg-[#2230d6] text-white font-extrabold text-[12px] cursor-pointer shadow-md transition-all active:scale-[0.99] border-0"
              >
