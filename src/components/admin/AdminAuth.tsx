      ...
      <div className="w-full max-w-sm p-6 rounded-2xl border border-slate-200 bg-slate-50/50 shadow-md space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-10 rounded-xl bg-[#2C3EFE] text-white font-extrabold text-xs shadow hover:bg-[#2230d6] active:scale-98 transition-all flex items-center justify-center gap-1.5 cursor-pointer border-0"
          >
