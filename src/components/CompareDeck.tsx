        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            ...
            <button
              ...
              className="px-4.5 py-2 rounded-xl bg-[#2C3EFE] hover:bg-[#2230d6] text-white font-extrabold text-xs shadow transition-all active:scale-98 cursor-pointer border-0"
            >
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-2.5 mb-5">
                ...
                <div>
                  <h2 className="text-sm font-extrabold text-slate-800">Compare Applications</h2>
                  ...
                  >
                    ...
                    <div className="flex gap-2.5 items-center pb-3 border-b border-slate-200">
                      ...
                      <div className="min-w-0">
                        <h3 className="text-xs font-extrabold text-slate-800 truncate">{app.name}</h3>
